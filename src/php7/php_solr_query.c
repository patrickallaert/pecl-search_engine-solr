...
/* {{{ proto SolrQuery SolrQuery::setDefaultOp(string op)
   Sets the q parameter */
    PHP_METHOD(SolrQuery, setDefaultOp)
    {
        solr_char_t *param_name = (solr_char_t *) "q.op";
        COMPAT_ARG_SIZE_T param_name_len = sizeof("q.op")-1;
        solr_char_t *param_value = NULL;
        COMPAT_ARG_SIZE_T param_value_len = 0;
