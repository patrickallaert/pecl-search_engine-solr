...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(SolrObject__get_args, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1, IS_MIXED, 1)
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(SolrDocument_offsetGet_args, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1, IS_MIXED, 1)
ZEND_ARG_INFO(SOLR_ARG_PASS_BY_REF_FALSE, fieldName)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(SolrDocument_current_args, SOLR_METHOD_RETURN_REFERENCE_FALSE, 0, IS_MIXED, 1)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_WITH_RETURN_TYPE_INFO_EX(SolrDocument_key_args, SOLR_METHOD_RETURN_REFERENCE_FALSE, 0, IS_MIXED, 1)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(SolrClient_sendUpdateStream_args, SOLR_ARG_PASS_REMAINING_BY_REF_FALSE, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1)
...
ZEND_BEGIN_ARG_INFO_EX(SolrQuery_setDefaultOp_args, SOLR_ARG_PASS_REMAINING_BY_REF_FALSE, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1)
ZEND_ARG_INFO(SOLR_ARG_PASS_BY_REF_FALSE, op)
ZEND_END_ARG_INFO()
...
ZEND_ARG_TYPE_INFO(SOLR_ARG_PASS_BY_REF_FALSE, start, IS_LONG, 0)
ZEND_END_ARG_INFO()

ZEND_BEGIN_ARG_INFO_EX(SolrQuery_setRows_args, SOLR_ARG_PASS_REMAINING_BY_REF_FALSE, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1)
ZEND_ARG_TYPE_INFO(SOLR_ARG_PASS_BY_REF_FALSE, rows, IS_LONG, 0)
ZEND_END_ARG_INFO()
...
ZEND_BEGIN_ARG_INFO_EX(SolrQuery_int_string_args, SOLR_ARG_PASS_REMAINING_BY_REF_FALSE, SOLR_METHOD_RETURN_REFERENCE_FALSE, 1)
ZEND_ARG_TYPE_INFO(SOLR_ARG_PASS_BY_REF_FALSE, value, IS_LONG, 0)
ZEND_ARG_TYPE_INFO(SOLR_ARG_PASS_BY_REF_FALSE, field_override, IS_STRING, 0)
ZEND_END_ARG_INFO()
...
static zend_function_entry solr_document_methods[] = {
	...
	PHP_ME(SolrDocument, __clone, Solr_no_args, ZEND_ACC_PUBLIC)
...
static zend_function_entry solr_input_document_methods[] = {
	...
	PHP_ME(SolrInputDocument, __clone, Solr_no_args, ZEND_ACC_PUBLIC)
	PHP_ME(SolrInputDocument, __sleep, Solr_no_args, ZEND_ACC_PUBLIC)
	PHP_ME(SolrInputDocument, __wakeup, Solr_no_args, ZEND_ACC_PUBLIC)
...
static zend_function_entry solr_client_methods[] = {
	...
	PHP_ME(SolrClient, __wakeup, Solr_no_args, ZEND_ACC_PUBLIC)
	PHP_ME(SolrClient, __clone, Solr_no_args, ZEND_ACC_PUBLIC)
...
static zend_function_entry solr_query_methods[] = {
	...
	PHP_ME(SolrQuery, setDefaultOp, SolrQuery_setDefaultOp_args, ZEND_ACC_PUBLIC)
	...
	PHP_ME(SolrQuery, setFacetLimit,  SolrQuery_int_string_args, ZEND_ACC_PUBLIC)
	...
	PHP_ME(SolrQuery, setFacetMinCount,  SolrQuery_int_string_args, ZEND_ACC_PUBLIC)
